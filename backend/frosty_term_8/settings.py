"""
Django settings for frosty_term_8 project.
...
ROOT_URLCONF = 'frosty_term_8.urls'
...
WSGI_APPLICATION = 'frosty_term_8.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_term_8 API",
    "DESCRIPTION": "API documentation for frosty_term_8 App",
    "VERSION": "v1",
}
